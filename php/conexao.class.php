 ...
 */
 abstract class conexao {
    ...
    protected static $larvore2 = LARVORE2;
    ...
    private static function conectar(){
        try {
            if(self::$Conexao == null){
                ...
                $opcao = [ PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES UTF8'];
                self::$Conexao = new PDO($dsn, self::$User, self::$Pass, $opcao);
            }
    ...
    protected static function Lconectar(){
    ...
    protected static function Lfazercon(){
        self::Lconectar();
